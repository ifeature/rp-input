...
var isValid = function isValid(value, filter) {
...
var createDebouced = function createDebouced(func, debouncedTime) {
  return debouncedTime ? (0, _lodash.debounce)(func, debouncedTime) : func;
};
...
var Input = function (_Component) {
  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Input.__proto__ || (0, _getPrototypeOf2.default)(Input)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (isValid(value, _this.props.filter)) {
        _this.setState({
          value: event.target.value
        }, function () {
          _this.onChangeDebounced(_this.state.value);
        });
      }
    }, _this.onChangeDebounced = createDebouced(_this.props.onChange, _this.props.debouncedTime), _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
...
Input.propTypes = {
  debouncedTime: _react.PropTypes.number,
  value: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]),
  maxLength: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.string]),
  filter: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.func]),
